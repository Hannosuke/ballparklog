...
__webpack_require__(/*! channels */ "./app/javascript/channels/index.js"); //datepicer
...
$("#datepicker").datepicker({
  ...
  onSelect: function onSelect(dateText) {
    ...
    var piyo = "".concat(year, "-").concat(month, "-").concat(day); //ajax処理を記述  
    ...
    .done(function (data) {
      ...
      $(data).each(function (i, game) {
        $(".game-select").append("<option>".concat(game.id, "</option>"));
      });
    }).fail(function () {
      alert("失敗だよ");
    });
...
$("#like_button").on("click", function (event) {
  event.preventDefault(); // TODO: user_idを取得する

  var hoge = $(".current-user-id").val(); // TODO: ballpark_log_idを取得する

  var fuga = $(".ballparklog-id").val(); // TODO: Ajax処理を書く 参考 http://semooh.jp/jquery/api/ajax/jQuery.ajax/options/

  $.ajax({
    type: "POST",
    url: "/ballpark_logs/".concat(fuga, "/likes"),
    data: {
      like: {
        user_id: hoge,
...
/******/ });
//# sourceMappingURL=application-769e854947d360b8623c.js.map